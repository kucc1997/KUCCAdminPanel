...
const EventEditForm = () => {
    ...
    const transformInputData = (input_data: any) => {
        ...
        console.log(transformed_input_data);
        transformed_input_data.date = parse(transformed_input_data.date, DATE_FORMAT, new Date());
        console.log(transformed_input_data.date);
